...
outList = []
walkFiles("D:/work_new/fish_client_adxe_lua/res", ".png", True, outList)

for file in outList:
    content = readDataFromFile(file, "rb")


    if content[0] == 0x89 and content[1] == 0x50 and content[2] == 0x4e:
        pass
    else:
        # print(content[0])
        # print(content[1])
