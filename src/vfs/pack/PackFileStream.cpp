...
bool PackFileStream::open(const std::string& path, FileStream::Mode mode)
{
	return false;
}

bool PackFileStream::open(const std::string& path, const PackFileInfo& fileInfo, uint32_t dataSecret)
{
